          ...
          <div className="grid grid-cols-1 items-center gap-10 lg:grid-cols-2">
            <div>
              ...
              <div className="mt-6 flex flex-col gap-3 sm:flex-row">
                <Link
                  href="/kom-i-gang"
                  className="rounded-2xl bg-emerald-700 px-5 py-3 text-center text-sm font-semibold text-white hover:bg-emerald-600"
                >
                  Start nå
                </Link>
                <Link
                  href="/login"
                  className="rounded-2xl border border-slate-200 bg-white px-5 py-3 text-center text-sm font-semibold hover:bg-slate-50"
                >
                  Logg inn
                </Link>
              </div>
  ...
  return (
    ...
    >
      ...
      <Link
        href={href}
        className={[
          "mt-6 block w-full rounded-2xl px-4 py-3 text-center text-sm font-semibold",
          highlight
